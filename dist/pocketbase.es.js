...
var Client = /** @class */ (function () {
    ...
    Client.prototype.send = function (path, reqOptions) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var options, data, cancelKey, controller, url, query, result, _j, _k, _l, wxFetch;
            var _this = this;
                ...
                switch (_m.label) {
                    case 0:
                        ...
                        if (!this.isFormData(options.body)) {
                            // TODO fix the body
                            if (options.body && typeof options.body) {
                                data = options.body.getData();
...
var FormData$1 = /** @class */ (function () {
    ...
    FormData.prototype.appendFile = function (name, path, fileName) {
        var buffer = this.fileManager.readFileSync(path);
    ...
    FormData.prototype.convert = function (data, files) {
        var boundaryKey = 'wxmpFormBoundary' + this.randString(); // 数据分割符，一般是随机的字符串
        ...
        endBoundaryArray.push.apply(endBoundaryArray, this.toUtf8Bytes(endBoundary));
    ...
    FormData.prototype.randString = function () {
        var result = '';
    ...
    FormData.prototype.getFileNameFromPath = function (path) {
        var idx = path.lastIndexOf("/");
        return path.substr(idx + 1);
    };
    FormData.prototype.formDataArray = function (boundary, name, value, fileName) {
        var dataString = '';
        var isFile = !!fileName;
        dataString += boundary + '\r\n';
        ...
        var dataArray = [];
        dataArray.push.apply(dataArray, this.toUtf8Bytes(dataString));
        if (isFile) {
            var fileArray = new Uint8Array(value);
            dataArray = dataArray.concat(Array.prototype.slice.call(fileArray));
        }
        dataArray.push.apply(dataArray, this.toUtf8Bytes("\r"));
        dataArray.push.apply(dataArray, this.toUtf8Bytes("\n"));
        return dataArray;
    };
    FormData.prototype.toUtf8Bytes = function (str) {
        var bytes = [];
        for (var i = 0; i < str.length; i++) {
            bytes.push.apply(bytes, this.utf8CodeAt(str, i));
    ...
    FormData.prototype.utf8CodeAt = function (str, i) {
        var out = [], p = 0;
...
export { Admin, AdminService, BaseAuthStore, BaseModel, ClientResponseError, Collection, CollectionService, CrudService, ExternalAuth, FormData$1 as FormData, ListResult, LocalAuthStore, LogRequest, LogService, RealtimeService, Record, RecordService, SchemaField, SettingsService, Client as default, getTokenPayload, isTokenExpired };
